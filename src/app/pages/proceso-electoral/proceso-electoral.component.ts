...
export class ProcesoElectoralComponent implements OnInit {
  ListUsuraios: any[] = [
    {
      id: 1,
      user: 'bob06',
  ...
  onAction(data: any) {
    if (data) {
      this.router.navigateByUrl('/proceso-electoral-action', { state: data });
    } else {
      this.router.navigateByUrl('/proceso-electoral-action');
    }
  }
